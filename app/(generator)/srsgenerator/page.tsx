                                    ...
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                                                Generate comprehensive SRS documents automatically
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-center max-w-3xl mx-auto">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-left">
                                            <div className="flex items-start space-x-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 transition-colors duration-300">
                                                ...
                                                <div>
                                                    <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1">AI-Powered Generation</h3>
                                                    <p className="text-sm text-gray-600 dark:text-gray-400">Intelligent SRS document creation</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-start space-x-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 transition-colors duration-300">
                                                ...
                                                <div>
                                                    <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1">Template-Based Structure</h3>
                                                    <p className="text-sm text-gray-600 dark:text-gray-400">Professional SRS document templates</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-start space-x-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-700/50 sm:col-span-2 lg:col-span-1 transition-colors duration-300">
                                                ...
                                                <div>
                                                    <h3 className="font-medium text-gray-900 dark:text-gray-100 mb-1">Export to Multiple Formats</h3>
                                                    <p className="text-sm text-gray-600 dark:text-gray-400">PDF, Word, and other formats</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
